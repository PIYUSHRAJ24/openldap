...
class RabbitMQ:
    ...
    def updateUser(self, data):
        try:
            self.credentials = pika.PlainCredentials(os.getenv('RABBITMQ_ACCOUNTS_USERNAME'),os.getenv('RABBITMQ_ACCOUNTS_PASSWORD'))
            self.accounts_connection = pika.BlockingConnection(pika.ConnectionParameters(os.getenv('RABBITMQ_ACCOUNTS_HOST'),os.getenv('RABBITMQ_ACCOUNTS_PORT'),os.getenv('RABBITMQ_ACCOUNTS_VHOST'), self.credentials))
